// ============================================
// TEMA.JS – Gestão de modo claro/escuro
// ============================================
...
export function getTema() {
  ...
  // Padrão: escuro (Angophones é dark por padrão)
  return TEMA_ESCURO;
}
...
/**
 * Actualiza o ícone do botão de toggle
 ...
 * @returns {HTMLElement} Botão de toggle
 */
...
export function inicializarTema() {
  ...
  if (window.matchMedia) {
    window.matchMedia('(prefers-color-scheme: dark)').addEventListener('change', (e) => {
      // Só actualiza se o utilizador não tiver definido preferência manual
